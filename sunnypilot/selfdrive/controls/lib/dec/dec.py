...
class DynamicExperimentalController:
  def __init__(self, CP: structs.CarParams, mpc, params=None):
    ...
    self._default_mode: int = int(self._params.get("DynamicExperimentalControlDefaultMode") or "0")
  ...
  def _read_params(self) -> None:
    if self._frame % int(1. / DT_MDL) == 0:
      ...
      self._default_mode = int(self._params.get("DynamicExperimentalControlDefaultMode") or "0")
